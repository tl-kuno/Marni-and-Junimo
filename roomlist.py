...
def init_room_list_and_items():
    ...
    pickle.dump(kitchen, p_kit)
    pickle.dump(pantry, p_pan)
    pickle.dump(bedroom, p_bed)
    pickle.dump(bathroom, p_bath)
    pickle.dump(porch, p_por)
    pickle.dump(alley, p_all)
    ...
    unpicked_kitchen = pickle.load(p_pan)
